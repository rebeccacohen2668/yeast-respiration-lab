...
const PartA = ({ onScore }) => {
  ...
  return (
    <div className="mb-16 text-right">
      ...
      <MultipleChoiceQnA qNum="1" points={5} onScore={onScore} question="על פי התצפיות והטבלה, מהו צבע האינדיקטור פנול-פתלאין בסביבה בסיסית ובסביבה חומצית?" options={["בסביבה בסיסית הצבע חסר צבע ובסביבה חומצית הוא ורוד.","בסביבה בסיסית הצבע ורוד ובסביבה חומצית הוא חסר צבע.","בסביבה בסיסית הצבע כחול ובסביבה חומצית הוא צהוב בהיר.","בשתי הסביבות הצבע נשאר ורוד אך בעוצמות שונות לחלוטין."]} correctAnswerIndex={1} explanation="במבחנה א' (בסיס) הצבע הפך לוורוד. במבחנות ב' ו-ג' (חומצה) הצבע נותר שקוף." />
      <MultipleChoiceQnA qNum="2" points={5} onScore={onScore} question="הסבירו מדוע במבחנה ג' נדרש מספר גדול יותר של טיפות בסיס (NaOH) מאשר במבחנה ב' בשלב II?" options={["מפני שבמבחנה ג' הוספו פחות מים ולכן ריכוז החומצה היה נמוך יותר.","מפני שהבסיס במבחנה ג' היה מרוכז יותר ולכן נדרשו יותר טיפות לסתירה.","מפני שבמבחנה ג' הוספו 3 טיפות חומצה, לעומת טיפה אחת בלבד במבחנה ב'.","מפני שהאינדיקטור פנול-פתלאין מתפרק מהר יותר בנוכחות חומצה HCl."]} correctAnswerIndex={2} explanation="הבסיס סותר את החומצה. ככל שיש יותר חומצה בתמיסה (3 טיפות לעומת 1), נדרשת כמות גדולה יותר של בסיס כדי לנטרול אותה." />
    </div>
  );
};
  ...
  return (
    <div className="mb-14 text-right">
      ...
      <MultipleChoiceQnA 
        ...
        options={["במבחנה 1 הריכוז הוא 0.10M, במבחנה 2 הריכוז הוא 0.010M ובמבחנה 3 הריכוז הוא 0.0010M.", "במבחנה 1 הריכוז הוא 0.50M, במבחנה 2 הריכוז הוא 0.250M ובמבחנה 3 הריכוז הוא 0.1250M.", "במבחנה 1 הריכוז הוא 0.25M, במבחנה 2 הריכוז הוא 0.125M ובמבחנה 3 הריכוז הוא 0.0625M.", "במבחנה 1 הריכוז הוא 0.25M, במבחנה 2 הריכוז הוא 0.025M ובמבחנה 3 הריכוז הוא 0.0025M."]} 
      ...
      <MultipleChoiceQnA qNum="5" points={6} onScore={onScore} question="הימצאות אתנול במבחנות היא משתנה בלתי תלוי אחד בניסוי שערכתם. מהו המשתנה הבלתי תלוי האחר בניסוי שערכתם?" options={["קצב פליטת הפחמן הדו-חמצני במהלך הנשימה.","מספר דסקיות השמרים המקובעות בתוך האגר.","ריכוז הגלוקוז בתמיסה שבתוך כל מבחנה.","טמפרטורת אמבט המים במהלך שלב ההדגרה."]} correctAnswerIndex={2} explanation="המשתנה הבלתי תלוי האחר בניסוי הוא ריכוז הגלוקוז בתמיסות שבהן שרו השמרים." />
      <MultipleChoiceQnA qNum="6" points={6} onScore={onScore} question="מדוע חשוב שדווקא מספר דסקיות שמרים (8 דסקיות) יהיה גורם קבוע בניסוי שערכתם?" options={["כדי להבטיח שלכל השמרים תהיה גישה שווה לחמצן באוויר.","כיוון שכמות השמרים משפיעה על קצב הנשימה ופליטת ה-CO2.","כדי שהמיהולים של הגלוקוז יישארו מדויקים לאורך זמן הניסוי.","כדי שדסקיות האגר לא יתפרקו עקב כמות גדולה של תוצרי לוואי."]} correctAnswerIndex={1} explanation="כמות השמרים (התאים / האנזימים) משפיעה על קצב תהליך הנשימה התאית. בניסוי נבדקה ההשפעה של משתנה בלתי תלוי אחר (ריכוז גלוקוז והימצאות אתנול), ולכן כל שאר הגורמים צריכים להישמר קבועים." />
      <MultipleChoiceQnA qNum="7" points={7} onScore={onScore} question="הציעו הסבר לתוצאות הניסוי שהתקבלו במבחנות C-A (הקשר בין גלוקוז לטיטרציה):" options={["ריכוז גלוקוז נמוך מזרז את נשימת השמרים ולכן מצריך יותר בסיס.","הגלוקוז הוא בסיסי וסותר את החומצה הפחמתית הנוצרת במים.","אין קשר ישיר בין ריכוז הגלוקוז במבחנות לבין כמות החומצה שנמדדה.","ככל שריכוז הגלוקוז גבוה, נוצר יותר CO2 שיוצר חומצה המצריכה בסיס."]} correctAnswerIndex={3} explanation="הגלוקוז הוא מגיב / מצע / סובסטרט בתהליך הנשימה התאית. ככל שריכוז הגלוקוז גבוה יותר, קצב תהליך הנשימה גבוה יותר. כתוצאה מכך נוצר יותר CO2 ונוצרת יותר חומצה פחמתית, ולכן נדרש מספר גדול יותר של טיפות בסיס לנטרול החומצה (עד לקבלת צבע ורוד)." />
      <MultipleChoiceQnA qNum="8" points={7} onScore={onScore} question="הציעו הסבר להבדל בין התוצאה שקיבלתם במבחנה D לתוצאה במבחנה A:" options={["האתנול מזרז את נשימת השמרים וגורם ליצירה מוגברת מאוד של פד''ח.","אתנול הוא חומר הממס שומנים ופוגע בחלבונים, מה שמעכב את הנשימה.","האתנול מגיב עם פנול-פתלאין ומשנה את צבעו מראש ללא קשר ל-pH.","ריכוז הגלוקוז במבחנה D1 היה נמוך משמעותית מריכוז הגלוקוז במבחנה A1."]} correctAnswerIndex={1} explanation="במבחנה D קיים אתנול בניגוד למבחנה A. האתנול פוגע בקרומי תאי השמרים, בחלבונים ובאנזימי הנשימה, ולכן קצב תהליך הנשימה התאית איטי יותר. כתוצאה מכך נוצר פחות CO2 ופחות חומצה, ולכן נדרש מספר קטן יותר של טיפות בסיס לנטרול החומצה." />
      <MultipleChoiceQnA qNum="9" points={6} onScore={onScore} question="מהי החשיבות של הוספת מבחנת בקרה המכילה מים ודסקיות שמרים בלבד (ללא גלוקוז)?" options={["לבדיקת עמידות הדסקיות לאורך זמן בטמפרטורה הגבוהה של האמבט.","כדי להשוות את קצב ייצור האתנול הפנימי של השמרים ללא סוכר חיצוני.","כדי להוכיח שהאגר אינו מתפרק במים ומפריש חומרים בסיסיים למבחנה.","כדי לוודא שהשינוי בחומציות נובע רק מפירוק הגלוקוז בתהליך הנשימה."]} correctAnswerIndex={3} explanation="הבקרה נועדה לשלול הסבר חלופי שעל פיו שינוי ה-pH מתרחש עקב תהליך אחר שאינו קשור להשפעת גלוקוז על קצב הנשימה התאית, וכן כדי לוודא שללא גלוקוז אין בשמרים תהליך שגורם לשינוי חומציות/בסיסיות התמיסה." />
      <MultipleChoiceQnA qNum="10" points={6} onScore={onScore} question="תלמידים טענו שהשפעת האתנול על קצב נשימה תאית תהיה דומה בכל היצורים החיים. האם טענתם נכונה?" options={["לא, כי רק יצורים חד-תאיים כמו שמרים נפגעים מממיסים אורגניים.","כן, כי אתנול הוא מקור אנרגיה חיובי עבור כל סוגי התאים בטבע.","כן, כי מבנה קרום התא והאנזימים דומה בבסיסו בכל היצורים החיים.","לא, כי חדירות האתנול לתאים של יונקים נמוכה בהרבה מלתאי שמרים."]} correctAnswerIndex={2} explanation="כן. לכל התאים יש חלבונים וקרומים. האתנול פוגע בחלבונים ובקרומי תאים, ולכן השפעת האתנול צפויה להיות דומה בכל היצורים." />
    </div>
  );
};
...
const PartC = ({ onScore }) => {
  return (
    <div className="mb-12 text-right">
      ...
      <MultipleChoiceQnA qNum="11" points={6} onScore={onScore} question="איזה סוג של הצגה גרפית הוא המתאים ביותר לתיאור התוצאות המוצגות בטבלה 3?" options={["דיאגרמת עמודות, כיוון שההשוואה בין הזנים השונים היא המטרה העיקרית.","גרף רציף (קו), כיוון שריכוז האתנול הוא משתנה כמותי רציף.","דיאגרמת עוגה, המראה את החלק היחסי של כל זן בכל מדידה.","גרף נקודות מפוזר, כיוון שאין קשר ישיר בין המדידות בטבלה."]} correctAnswerIndex={1} explanation="ההצגה הגרפית המתאימה היא גרף רציף (עקום). הנימוק לכך הוא שהמשתנה הבלתי תלוי (ריכוז אתנול) הוא משתנה רציף / כמותי / מדיד, ויש משמעות לערכי הביניים." />
      <MultipleChoiceQnA qNum="12" points={6} onScore={onScore} question="תארו את התוצאות של ניסוי 1 כפי שהן משתקפות בנתוני טבלה 3." options={["קצב ההתרבות עולה עם עליית ריכוז האתנול עד לשיא מסוים ואז יורד.","ריכוז האתנול אינו משפיע על זן ב', אך גורם למותם של כל תאי זן א'.","ככל שריכוז האתנול עולה, חלה ירידה הדרגתית בקצב ההתרבות בשני הזנים.","זן א' מתרבה מהר יותר מזן ב' ככל שריכוז האתנול בתמיסה עולה."]} correctAnswerIndex={2} explanation="בטווח ריכוזי אתנול 0-4% אין כמעט שינוי בקצב ההתרבות של שני הזנים. ככל שריכוז האתנול גבוה יותר (מ-4% עד 16%), קצב ההתרבות של שני הזנים יורד. קצב ההתרבות של זן ב' יורד לאט יותר בהשוואה לזן א' ולכן הוא גבוה יותר." />
      <MultipleChoiceQnA qNum="13" points={7} onScore={onScore} question="קבעו איזה משני הזנים - זן א או זן ב - עמיד יותר להשפעות האתנול. נמקו." options={["זן א', כי הוא רגיש יותר ומגיב מהר יותר לשינויי ריכוז בסביבה.","שניהם עמידים באותה מידה בטווח הריכוזים של 0-4% אתנול.","לא ניתן לקבוע זאת בוודאות על פי הנתונים המוגבלים המופיעים בטבלה.","זן ב', כיוון שקצב ההתרבות שלו נותר גבוה יותר בהשוואה לזן א' בכל ריכוז."]} correctAnswerIndex={3} explanation="זן ב' עמיד יותר להשפעות האתנול. הנימוק מהגרף: ניתן לראות שככל שמעלים את ריכוז האתנול, קצב ההתרבות של זן ב' גבוה יותר בהשוואה לזן א'. כמו כן, בריכוז הגבוה ביותר (16%) זן ב' ממשיך להתרבות בעוד זן א' אינו מתרבה כלל." />
      ...
      <MultipleChoiceQnA qNum="14" points={6} onScore={onScore} question="על פי גרף 2 והמידע על סוכר הטרהלוז, מהוא ההסבר לתוצאות של זן ב בטבלה 1?" options={["זן ב' מייצר פחות טרהלוז כדי לחסוך באנרגיה הדרושה להתמודדות עם האתנול.","זן ב' שומר על ריכוז טרהלוז גבוה יותר בכל הריכוזים, המגן על תאיו.","הטרהלוז בזן ב' הופך לחומר רעיל בסביבת אתנול, מה שמזרז את ההתרבות.","אין קשר סיבתי מוכח בין רמת הטרהלוז בתא לבין קצב ההתרבות שנמדד."]} correctAnswerIndex={1} explanation="על פי הגרף, בזן ב' יש יותר טרהלוז ככל שריכוזי האתנול גבוהים יותר. טרהלוז מגן מפני השפעת האתנול, ולכן קצב ההתרבות של זן ב' גבוה יותר בהשוואה לזן א'." />
      ...
      <MultipleChoiceQnA qNum="15" points={6} onScore={onScore} question="מדוע קצב הפעילות הנמוך של האנזים המפרק טרהלוז בזן ב' מאפשר לו קצב התרבות גבוה יותר?" options={["פעילות נמוכה חוסכת לתא אנרגיה רבה המנוצלת כולה לטובת חלוקת תאים.","האנזים המפרק הוא רעלן בעצמו, ולכן רמה נמוכה שלו מאפשרת חיים תקינים.","פעילות נמוכה של האנזים המפרק גורמת להצטברות טרהלוז בתא, המגן עליו.","קצב פירוק נמוך מעיד על כך שהתא נמצא בתרדמה זמנית המגנה על השמרים."]} correctAnswerIndex={2} explanation="כאשר פעילות האנזים המפרק טרהלוז נמוכה יותר, כמות הטרהלוז שנשארת בתאי השמרים גדולה יותר. הטרהלוז מגן על תאי השמרים מפני נזקי האתנול, ולכן זן ב' מוגן יותר / עמיד יותר, וקצב ההתרבות שלו גדול משל זן א'." />
      <MultipleChoiceQnA qNum="16" points={7} onScore={onScore} question="הסבירו כיצד הגנה על קרום התא בסביבה שיש בה אתנול מאפשרת לתאי השמרים לשמור על הומאוסטזיס." options={["על ידי הפיכת הקרום לאטום לחלוטין לכניסה של כל חומר חיצוני מהסביבה.","הקרום המוגן הופך למקור האנרגיה החלופי המועדף על השמרים בניסוי זה.","הגנה על הקרום מונעת פליטת פחמן דו-חמצני ובכך שומרת על רמת חומציות גבוהה.","הגנה על הקרום שומרת על בררנותו, מונעת חדירת רעלים ושומרת על סביבה יציבה."]} correctAnswerIndex={3} explanation="האתנול פוגע בקרום התא (בפוספוליפידים / בחלבונים). הגנה על קרום התא מאפשרת שמירה על בררנות הקרום ועל פעילות החלבונים. כך הסביבה הפנימית נשמרת שונה מהחיצונית ויש שמירה על מאזן מומסים (הומיאוסטזיס)." />
    </div>
  );
};
